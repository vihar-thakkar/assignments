		...
		<div class="row px-xl-5">
			<div class="col-lg-7 mb-5">
				<div class="contact-form bg-light p-30">
					...
					%>
					<form action="ProductController" method="post" name="sentMessage"
						enctype="multipart/form-data">
						<input type="hidden" name="pid" value="<%=p.getPid()%>">
						<input type="hidden" name="sid" value="<%=s.getId()%>">
						<div class="control-group">
							<img src="image/<%=p.getImage()%>" height="100px" width="100px"> 
						</div>
						<div class="control-group">
							<input type="file" class="form-control" name="image" id="name"
								placeholder="Product Image" required="required"
						...
						<div class="control-group">
							<input type="text" class="form-control" name="pcategory"
								id="name" value="<%=p.getPcategory() %>" required="required"
								data-validation-required-message="Please enter your name" />
							<p class="help-block text-danger"></p>
						</div>
						<div class="control-group">
							<input type="text" class="form-control" name="pdesc" id="email"
								value="<%=p.getPdescription() %>" required="required"
						...
						<div>
							<button class="btn btn-primary py-2 px-4" type="submit"
								name="action" value="update" id="sendMessageButton">
								Update</button>
						</div>
					</form>
				</div>
