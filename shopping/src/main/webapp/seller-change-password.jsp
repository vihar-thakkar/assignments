					...
					<form action="SellerController" method="post" name="sentMessage">
						...
						<div>
							<button class="btn btn-primary py-2 px-4" type="submit"
								name="action" value="change password" id="sendMessageButton">
