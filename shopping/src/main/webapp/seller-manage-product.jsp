        ...
        <div class="row px-xl-5">
            <div class="col-lg-12 table-responsive mb-5">
                <table class="table table-light table-borderless table-hover text-center mb-0">
                    ...
                    <!-- todo need to replace 0 with s.getId() -->
                    <%List<product> list = productDao.getProductListBySellerId(0); %>
                        <%for(product p:list){ %>
                        <tr>
                            <td class="align-middle"><img src="image/<%=p.getImage() %>" alt="" style="width: 50px;"></td>
